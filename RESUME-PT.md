...
- Pretensão salarial: R$13.000,00 PJ
...
- GraphQL, RESTful;
- Python, Django, Node.js, Typescript, Flask, FastAPI;
- PostgreSQL, SQL;
...
## Estudos:
Atualmente estou me aperfeiçoando em soluções backend como Kubernetes, ElasticSearch, otimizações em bancos de dados e microsserviços. Tenho interesse também em conhecer mais profundamente Java, Elixir, Rust e inteligência artificial.
